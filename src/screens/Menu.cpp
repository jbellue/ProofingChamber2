...
void Menu::beginImpl() {
    ...
    // Note: Pass nullptr since Menu doesn't have direct access to AppContext storage
    // The menus should already be initialized in main.cpp with proper context
    initializeAllMenus(nullptr);
